...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vb.button.setOnClickListener {
            appWebExtensionPortDelegate.port?.postMessage(JSONObject(mapOf("text" to "to Web From Native")))
        }
        ...
        runtime.webExtensionController
            ...
            .accept(object : GeckoResult.Consumer<WebExtension> {
                ...
                override fun accept(extension: WebExtension?) {
                    Log.e(TAG, "extension accepted: ${extension!!.metaData.description}")
                    ...
                    geckoSession.webExtensionController.setMessageDelegate(extension,
                        object : WebExtension.MessageDelegate {
                            override fun onMessage(nativeApp: String, message: Any,
                                ...
                                Log.e(TAG, "onMessage: $nativeApp, $message, $sender")
                                Toast.makeText(this@MainActivity, "onMessage: $nativeApp, $message, $sender", Toast.LENGTH_SHORT).show()
                                return null
                            }

                            override fun onConnect(port: WebExtension.Port) {
                                Log.e(TAG, "onConnect: $port")
                ...
                e ->
                Log.e(TAG, "Error registering WebExtension", e) }
